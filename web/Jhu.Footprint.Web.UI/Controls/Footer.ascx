<%@ Control Language="C#" AutoEventWireup="true" Inherits="Jhu.Footprint.Web.UI.Controls.Footer" Codebehind="Footer.ascx.cs" %>
<%= Application[Jhu.Graywulf.Web.UI.Constants.ApplicationCopyright] %> - powered by Graywulf
|
