        ...
        <table class="gw-form">
            <tr>
                ...
                <td class="gw-form-field">
                    ...
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="circleName" ValidationGroup="circleModal" Display="Dynamic">
                        <br />Name is required.
                    </asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator runat="server" ID="circleNameFormatValidator" ControlToValidate="circleName" ValidationGroup="circleModal" Display="Dynamic">
